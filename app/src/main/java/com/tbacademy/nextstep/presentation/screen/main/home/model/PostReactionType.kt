...
enum class PostReactionType(val iconRes: Int, val titleRes: Int = R.string.react, val backgroundRes: Int) {
    ...
    CHEER(iconRes = R.drawable.ic_reaction_cheer_24px, titleRes = R.string.cheer, backgroundRes = R.drawable.bg_reaction_cheer),
    TASK(iconRes = R.drawable.ic_reaction_task_24px, R.string.well_done, backgroundRes = R.drawable.bg_reaction_task)
}